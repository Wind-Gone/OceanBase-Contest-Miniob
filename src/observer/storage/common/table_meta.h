...
public:
  ...
  const IndexMeta * find_index_by_fields(char * const*field, const int field_num) const;
...
public:
  ...
  int test_num() const;
  void increase_test_num();
  RC set_field_unique(const char * field_name, bool new_unique);
