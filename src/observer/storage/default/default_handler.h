...
public:
   ...
   * @return
   */
  RC create_index(Trx *trx, const char *dbname, const char *relation_name, const char *index_name, char* const *, const int attribute_num, const bool unique);
   ...
   * @return
   */
  RC insert_record(Trx * trx, const char *dbname, const char *relation_name, int tuple_num, const InsertTuple *tuples);
