...
TEST(test_bp_manager, test_bp_manager_simple_lru) {
  ...
  bp_manager.release_maybe(frame1->file_desc, frame1->page.page_num, frame1);
  ...
  bp_manager.release_maybe(frame2->file_desc, frame2->page.page_num, frame2);
  ...
  bp_manager.release_maybe(frame3->file_desc, frame3->page.page_num, frame3);
  ...
  bp_manager.release_maybe(frame4->file_desc, frame4->page.page_num, frame4);
